...
const ForgotPasswordPage = () => {
  ...
  <motion.div
    ...
    className='w-16 h-16 bg-purple-700 rounded-full flex items-center justify-center mx-auto mb-4'
  >
...
<div className='px-8 py-4 bg-gray-300 bg-opacity-50 flex justify-center'>
  <Link to={"/login"} className='text-sm text-blue-800 hover:underline flex items-center'>
